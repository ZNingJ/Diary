    ...
    var e = [CKEDITOR.ALT, CKEDITOR.SHIFT, CKEDITOR.CTRL], n = /\$\{(.*?)\}/g, q = function () {
        ...
        return function (b, g) {
            ...
            if (f[g]) {
                a = f[g];
                for (var h, i, k = [],
                         c = 0; c < e.length; c++)i = e[c], h = a / e[c], 1 < h && 2 >= h && (a -= i, k.push(d[i]));
        ...
        title: l.title, minWidth: 600, minHeight: 400, contents: [{
            id: "info", label: j.lang.common.generalTab, expand: !0, elements: [{
                ...
                focus: function () {
                    ...
                    for (var d = '<div class="cke_accessibility_legend" role="document" aria-labelledby="' + m + '_arialbl" tabIndex="-1">%1</div><span id="' + m + '_arialbl" class="cke_voice_label">' + l.contents + " </span>",
                             f = [], b = l.legend, j = b.length, g = 0; g < j; g++) {
